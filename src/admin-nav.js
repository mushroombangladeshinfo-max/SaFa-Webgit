...
const SEARCH_INDEX = [
  ...
  { href: 'job-activities.html',    label: 'Job Activities',  icon: '≡', hint: 'Every applications/message/call, chronologically', keywords: 'job activities log timeline history networking' },

const l=[{key:"orders",href:"admin.html",label:"Orders",icon:"📦"},{key:"customers",href:"customers.html",label:"Customers",icon:"👤"},{key:"products",href:"products.html",label:"Products",icon:"🍄"},{key:"expenses",href:"expenses.html",label:"Expenses",icon:"💰"},{key:"pipeline",href:"pipeline.html",label:"Pipeline",icon:"🤝"},{key:"insights",href:"insights.html",label:"Insights",icon:"📊"}],p=[{href:"quick-log.html",label:"⚡ Quick Log"},{href:"farm-log.html",label:"📋 Farm Log"},{href:"farm-analytics.html",label:"📈 Farm Analytics"},{href:"dashboard.html",label:"📡 IoT Dashboard"}];function u(){if(document.getElementById("admin-nav-styles"))return;const a=document.createElement("style");a.id="admin-nav-styles",a.textContent=`

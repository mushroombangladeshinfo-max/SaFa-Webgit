import{s}from"./supabase-BELNfT1R.js";import{A as c}from"./admin-auth-4ZiUUGs_.js";async function i(){try{const{data:{user:a}}=await s.auth.getUser();if(!a)return;const t=a.user_metadata?.first_name||a.email.split("@")[0],e=document.getElementById("nav-account-link");if(e&&(e.outerHTML=`

import{s}from"./main-q8TLCeIc.js";async function c(){var a;try{const{data:{user:t}}=await s.auth.getUser();if(!t)return;const e=((a=t.user_metadata)==null?void 0:a.first_name)||t.email.split("@")[0],n=document.getElementById("nav-account-link");n&&(n.outerHTML=`

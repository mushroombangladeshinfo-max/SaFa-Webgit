(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();function T(){const t=document.getElementById("nav");if(!t)return;window.addEventListener("scroll",()=>{t.classList.toggle("scrolled",window.scrollY>56)},{passive:!0});const e=document.querySelectorAll("section[id]"),o=document.querySelectorAll(".nav-links a");e.length&&o.length&&window.addEventListener("scroll",()=>{let i="";e.forEach(n=>{window.scrollY>=n.offsetTop-80&&(i=n.id)}),o.forEach(n=>{n.classList.toggle("active",n.getAttribute("href")==="#"+i)})},{passive:!0})}function M(){const t=document.getElementById("hamburger"),e=document.getElementById("mobileMenu");!t||!e||(t.addEventListener("click",()=>{const o=t.classList.toggle("open");e.classList.toggle("open",o),document.body.style.overflow=o?"hidden":""}),document.addEventListener("click",o=>{e.classList.contains("open")&&!e.contains(o.target)&&!t.contains(o.target)&&g()}),window.addEventListener("resize",()=>{window.innerWidth>=768&&g()}))}function g(){const t=document.getElementById("hamburger"),e=document.getElementById("mobileMenu");t&&t.classList.remove("open"),e&&e.classList.remove("open"),document.body.style.overflow=""}function q(){document.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",e=>{const o=document.querySelector(t.getAttribute("href"));o&&(e.preventDefault(),o.scrollIntoView({behavior:"smooth"}),g())})})}function A(){const t=document.querySelectorAll(".pl-filter"),e=document.querySelectorAll(".pl-card");t.length&&t.forEach(o=>{o.addEventListener("click",()=>{t.forEach(n=>n.classList.remove("active")),o.classList.add("active");const i=o.getAttribute("data-filter");e.forEach(n=>{const r=i==="all"||n.getAttribute("data-category")===i;n.style.display=r?"flex":"none",r&&(n.classList.remove("show"),setTimeout(()=>n.classList.add("show"),50))})})})}function B(){const t=new IntersectionObserver(o=>{o.forEach((i,n)=>{i.isIntersecting&&setTimeout(()=>{i.target.classList.add("show")},n*70)})},{threshold:.08});document.querySelectorAll(".fi").forEach(o=>t.observe(o));const e=document.getElementById("recipeVid");e&&new IntersectionObserver(i=>{i.forEach(n=>{n.isIntersecting?n.target.play().catch(r=>console.warn("[SaFa] Autoplay blocked:",r)):n.target.pause()})},{threshold:.1}).observe(e)}const p=500,k=60,h="safaCart",b="activeCoupon",L={SAFA10:"10% discount applied!",WELCOME:"Welcome discount applied!"},D=`
  ...
  <div class="cart-drawer" id="cartDrawer">
  ...
  </div>`;function c(){try{return JSON.parse(localStorage.getItem(h)||"{}")}catch{return{}}}function f(t){localStorage.setItem(h,JSON.stringify(t))}function $(){localStorage.removeItem(h),localStorage.removeItem(b)}function I(t,e,o,i="",n=""){const r=c();r[o]?r[o].qty+=1:r[o]={name:t,price:Number(e),qty:1,unit:i,image:n},f(r)}function H(t,e){const o=c();o[t]&&(o[t].qty+=e,o[t].qty<=0&&delete o[t],f(o))}function w(){return Object.values(c()).reduce((t,e)=>t+e.qty,0)}function z(){return Object.values(c()).reduce((t,e)=>t+e.price*e.qty,0)}let m=null;function y(){const t=w();if(m!==null&&t>m){const l=document.querySelector(".nav-icon");l&&(l.classList.remove("cart-bounce"),l.offsetWidth,l.classList.add("cart-bounce"))}m=t;const e=document.querySelector(".cart-items-container"),o=document.querySelector(".cart-subtotal span:last-child");if(!e)return;const i=c(),n=Object.entries(i);if(!n.length){e.innerHTML=`
    ...
    <div style="margin-top:20px;padding-top:18px;
    ...
    </div>`;e.innerHTML=E+s+O,o&&(o.textContent=r.toLocaleString()+" ৳")}function F(){const t=document.getElementById("cartOverlay"),e=document.getElementById("cartDrawer");!t||!e||(t.classList.add("active"),e.classList.add("active"),document.body.style.overflow="hidden")}function P(){const t=document.getElementById("cartOverlay"),e=document.getElementById("cartDrawer");if(!t||!e)return;const o=e.classList.toggle("active");t.classList.toggle("active",o),document.body.style.overflow=o?"hidden":""}function _(){const t=document.getElementById("cartCoupon"),e=document.getElementById("couponMsg");if(!t||!e)return;const o=t.value.trim().toUpperCase();e.style.display="block",L[o]?(e.textContent="✓ "+L[o],e.style.color="#5fcf80",localStorage.setItem(b,o)):(e.textContent="✕ Invalid or expired coupon code.",e.style.color="#d0724f",localStorage.removeItem(b))}function R(){document.getElementById("cartDrawer")||document.body.insertAdjacentHTML("afterbegin",D),y()}function x(){const t=document.getElementById("orderItems"),e=document.getElementById("emptyCart");if(!t)return;const o=c(),i=Object.entries(o);if(!i.length){t.innerHTML="",e&&(e.style.display="block"),v(0);return}e&&(e.style.display="none");let n=0;t.innerHTML=i.map(([r,s])=>{const a=s.price*s.qty;n+=a;const d=!!s.image;return`
      ...
      </div>`}).join(""),v(n)}function v(t){const e=t>=p||t===0?0:k,o=t+e,i=document.getElementById("subtotalVal"),n=document.getElementById("deliveryVal"),r=document.getElementById("totalVal"),s=document.getElementById("freeDeliveryBadge");if(i&&(i.textContent="৳"+t.toLocaleString()),n&&(n.textContent=e===0?"Free 🎉":"৳"+e),r&&(r.textContent="৳"+o.toLocaleString()),s){const a=t>=p&&t>0;s.style.display=a?"flex":"none"}}function N(t,e){const o=c();o[t]&&(o[t].qty+=e,o[t].qty<=0&&delete o[t],f(o),x(),y())}function j(){const t=document.querySelectorAll(".add-to-cart-btn");t.length&&(t.forEach(e=>{e.addEventListener("click",function(o){o.preventDefault(),o.stopPropagation();const i=this.dataset.name||"Product",n=parseInt(this.dataset.price,10)||0,r=this.dataset.id||"product_"+Date.now(),s=this.dataset.unit||"",a=this.dataset.image||"";if(!n){console.warn("[SaFa] add-to-cart: missing data-price on",this);return}I(i,n,r,s,a),y(),F();const d=this.innerHTML;this.innerHTML="✓ Added!",this.style.background="var(--g500, #2a5040)",this.style.color="#fff",setTimeout(()=>{this.innerHTML=d,this.style.background="",this.style.color=""},1400)})}),console.log(`[SaFa] Wired ${t.length} add-to-cart button(s)`))}window.addToCart=I;window.updateQuantity=H;window.toggleCart=P;window.applyCoupon=_;window.updateCheckoutQty=N;window.closeMenu=g;window.playRV=function(){const t=document.getElementById("recipeVid"),e=document.getElementById("rvOverlay");!t||!e||(e.classList.add("hidden"),t.play())};window.getCart=c;window.saveCart=f;window.clearCart=$;window.getCartCount=w;window.getCartTotal=z;window.renderItems=x;window.updateTotals=v;window.renderCartDrawer=y;window.FREE_SHIPPING_THRESHOLD=p;window.DELIVERY_FEE=k;document.addEventListener("DOMContentLoaded",()=>{T(),M(),q(),R(),A(),B(),j(),x();const t=document.querySelector(".nav-dot");if(t){const e=w();t.style.display=e>0?"block":"none"}});

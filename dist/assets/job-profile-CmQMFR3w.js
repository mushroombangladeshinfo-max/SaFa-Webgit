import{e as p}from"./html-utils-B4ngS3jJ.js";const l="jobActiveProfileId";function a(){const e=localStorage.getItem(l);return e?+e:null}function n(e){localStorage.setItem(l,String(e))}async function c(e){const{data:r}=await e.from("job_profiles").select("id,profile_name").order("profile_name");return r||[]}async function b(e){const r=await c(e);if(!r.length)return null;const i=a();return i&&r.some(o=>o.id===i)?i:(n(r[0].id),r[0].id)}function u(){if(document.getElementById("profile-switcher-styles"))return;const e=document.createElement("style");e.id="profile-switcher-styles",e.textContent=`
  ...
  `,document.head.appendChild(e)}async function m(e,r,i){u(),r.className="profile-switcher-bar";const o=await c(e),f=a();r.innerHTML=`

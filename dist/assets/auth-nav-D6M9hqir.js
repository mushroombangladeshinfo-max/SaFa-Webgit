import{s as i}from"./main-zuamY0M2.js";const o=["mushroombangladesh.info@gmail.com","quazishab@gmail.com"];async function c(){var t;try{const{data:{user:a}}=await i.auth.getUser();if(!a)return;const e=((t=a.user_metadata)==null?void 0:t.first_name)||a.email.split("@")[0],n=document.getElementById("nav-account-link");if(n&&(n.outerHTML=`
